...
_CHROME_CSS = (
    ...
    "div[data-testid='column']:has(#cult-soil-card),div[data-testid='column']:has(#cult-chem-card),div[data-testid='column']:has(#cult-climate-card),div[data-testid='column']:has(#cult-farm-card){background:#ffffff!important;border:2.5px solid rgba(20,20,15,0.30)!important;border-radius:20px!important;padding:32px 28px 28px!important;box-shadow:0 6px 24px rgba(15,40,24,0.12),0 2px 6px rgba(15,40,24,0.07)!important;margin:4px!important;}"
