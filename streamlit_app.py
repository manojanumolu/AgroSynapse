...
_CHROME_CSS = (
    ...
    "html,body,.stApp{background:#faf8f3!important;}"
    ...
    "animation:asNavIn 0.13s ease-out both!important;}"
    "@keyframes asNavIn{from{filter:blur(5px);opacity:0.85}to{filter:blur(0);opacity:1}}"
    ...
    "div[data-testid='stColumn']:has(#cult-soil-card),div[data-testid='stColumn']:has(#cult-chem-card),div[data-testid='stColumn']:has(#cult-climate-card),div[data-testid='stColumn']:has(#cult-farm-card){background:#ffffff!important;border:2px solid rgba(20,20,15,0.18)!important;border-radius:20px!important;padding:24px 22px 20px!important;box-shadow:0 4px 20px rgba(15,40,24,0.10),0 1px 4px rgba(15,40,24,0.06)!important;}"
    "div[data-testid='stColumn']:has(#cult-soil-card)>div[data-testid='stVerticalBlock'],div[data-testid='stColumn']:has(#cult-chem-card)>div[data-testid='stVerticalBlock'],div[data-testid='stColumn']:has(#cult-climate-card)>div[data-testid='stVerticalBlock'],div[data-testid='stColumn']:has(#cult-farm-card)>div[data-testid='stVerticalBlock']{gap:0!important;}"
    "div[data-testid='stColumn']:has(#cult-soil-card) .tool-block,div[data-testid='stColumn']:has(#cult-chem-card) .tool-block,div[data-testid='stColumn']:has(#cult-climate-card) .tool-block,div[data-testid='stColumn']:has(#cult-farm-card) .tool-block{background:transparent!important;border:0!important;box-shadow:none!important;padding:0!important;}"
    "div[data-testid='stColumn']:has(#cult-soil-card) .chem-grid,div[data-testid='stColumn']:has(#cult-chem-card) .chem-grid{background:transparent!important;border:0!important;padding:0!important;}"
    "div[data-testid='stColumn']:has(#cult-farm-card) .farm-grid{background:transparent!important;border:0!important;padding:0!important;}"
    ...
    "div[data-testid='stColumns']:has(.synth-text),div[data-testid='stHorizontalBlock']:has(.synth-text){background:linear-gradient(135deg,#062515 0%,#0f2818 62%,#173b24 100%)!important;border-radius:20px!important;margin-top:14px!important;border:1px solid rgba(250,248,243,0.12)!important;box-shadow:0 4px 20px rgba(15,40,24,0.18)!important;align-items:center!important;gap:0!important;overflow:hidden!important;padding:0!important;}"
    "div[data-testid='stColumns']:has(.synth-text)>[data-testid='stColumn']>[data-testid='stVerticalBlock'],div[data-testid='stHorizontalBlock']:has(.synth-text)>[data-testid='stColumn']>[data-testid='stVerticalBlock']{padding:28px 24px!important;gap:0!important;}"
    "div[data-testid='stColumns']:has(.synth-text)>[data-testid='stColumn']:first-child>[data-testid='stVerticalBlock'],div[data-testid='stHorizontalBlock']:has(.synth-text)>[data-testid='stColumn']:first-child>[data-testid='stVerticalBlock']{padding:28px 36px!important;}"
    ".synth-text{display:block;}"
    ".synth-text-title{font-family:'Instrument Serif','Times New Roman',serif;font-size:28px;font-weight:400;color:#faf8f3;line-height:1;letter-spacing:-0.02em;}"
    ".synth-text-sub{font-size:14px;color:rgba(250,248,243,0.7);margin-top:8px;}"
    "div[data-testid='stColumns']:has(.synth-text) [data-testid='stButton']>button,div[data-testid='stHorizontalBlock']:has(.synth-text) [data-testid='stButton']>button{background:#5a8a3a!important;color:#faf8f3!important;border:0!important;font-weight:600!important;padding:14px 20px!important;font-size:14px!important;border-radius:999px!important;white-space:nowrap;}"
    "div[data-testid='stColumns']:has(.synth-text) [data-testid='stButton']>button:hover,div[data-testid='stHorizontalBlock']:has(.synth-text) [data-testid='stButton']>button:hover{background:#6a9a46!important;}"
    ".climate-tile{overflow:visible!important;}"
    ...
    + ".topbar-nav a.active{background:" + _ac_alpha + "!important;color:" + _ac_mid + "!important;box-shadow:none!important;font-weight:600!important;border-radius:999px!important;border-bottom:0!important;}"
    ...
    ".home-pipeline-grid{grid-template-columns:1fr 1fr!important;gap:12px!important;}"
    ".home-pipeline-grid>div>p{display:none!important;}"
    ".home-pipeline-grid>div>div:last-child{display:none!important;}"
    ".home-pipeline-grid>div{padding:16px 14px!important;}"
    ...
    "div[data-testid='stColumns']:has(.synth-text) [data-testid='stButton']>button,div[data-testid='stHorizontalBlock']:has(.synth-text) [data-testid='stButton']>button{width:100%!important;}"
    "div[data-testid='stVerticalBlock']:has(#diag-specimen-card){margin-bottom:24px!important;}"
    ".tool-page-title{font-size:clamp(32px,8vw,52px)!important;}"
    ".tool-page-sub{font-size:13px!important;}"
...
<p class="tool-block-sub" style="margin-bottom:12px;">Historical yield + cultivation system. Used to weight output probability.</p>""", unsafe_allow_html=True)
    ...
    _sc1, _sc2 = st.columns([3.5, 1.2])
    with _sc1:
        st.markdown("""<div class="synth-text">
  <div class="synth-text-title">Ready to synthesize.</div>
  <div class="synth-text-sub">All four vectors complete. Expected synthesis time: ~2.4 seconds.</div>
</div>""", unsafe_allow_html=True)
    with _sc2:
