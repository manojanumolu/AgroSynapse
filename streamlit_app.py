...
_CHROME_CSS = (
    ...
    ".tool-header{margin-bottom:22px!important;padding-bottom:18px!important;}"
    "div[data-testid='column']:has(#cult-soil-card),div[data-testid='column']:has(#cult-chem-card),div[data-testid='column']:has(#cult-climate-card),div[data-testid='column']:has(#cult-farm-card){background:#fdfbf6;border:1px solid rgba(20,20,15,0.12);border-radius:20px;padding:16px 18px 14px;box-shadow:0 10px 24px rgba(15,40,24,0.05);overflow:hidden;}"
    ...
    "div[data-testid='stElementContainer']:has(#ready-synth-card) + div[data-testid='stHorizontalBlock'] [data-testid='stButton']>button{background:#5a8a3a!important;color:#faf8f3!important;border:0!important;font-weight:700!important;}"
